...
# Form implementation generated from reading ui file 'update_in_log.ui'
#
...
class Ui_update_in_log(object):
    def setupUi(self, update_in_log):
        update_in_log.setObjectName("update_in_log")
        update_in_log.resize(660, 500)
        self.verticalLayoutWidget = QtWidgets.QWidget(update_in_log)
        ...
        self.cancel_pushButton = QtWidgets.QPushButton(update_in_log)
        ...
        self.both_btn = QtWidgets.QPushButton(update_in_log)
        ...
        self.retranslateUi(update_in_log)
        QtCore.QMetaObject.connectSlotsByName(update_in_log)

    def retranslateUi(self, update_in_log):
        _translate = QtCore.QCoreApplication.translate
        update_in_log.setWindowTitle(_translate("update_in_log", "确认修改调入记录"))
        self.label_6.setText(_translate("update_in_log", "调入日期："))
        self.label_2.setText(_translate("update_in_log", "装备编码："))
        self.label_3.setText(_translate("update_in_log", "装备名称："))
        self.label.setText(_translate("update_in_log", "规格型号："))
        self.label_9.setText(_translate("update_in_log", "配发单位："))
        self.label_10.setText(_translate("update_in_log", "部署位置："))
        self.label_4.setText(_translate("update_in_log", "操作类型："))
        self.comboBox.setItemText(0, _translate("update_in_log", "调入"))
        self.comboBox.setItemText(1, _translate("update_in_log", "调出"))
        self.label_5.setText(_translate("update_in_log", "操作数量："))
        self.label_7.setText(_translate("update_in_log", "责任人："))
        self.label_8.setText(_translate("update_in_log", "责任单位："))
        self.cancel_pushButton.setText(_translate("update_in_log", "取消"))
        self.both_btn.setText(_translate("update_in_log", "修改调入记录和结存数量"))
