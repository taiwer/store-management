...
class Ui_home(object):
    ...
    def retranslateUi(self, home):
        ...
        home.setWindowTitle(_translate("home", "机要装备管理系统V2"))
        self.groupBox.setTitle(_translate("home", "装备操作"))
        self.new_material_pushButton.setText(_translate("home", "单件新增"))
        self.in_material_pushButton.setText(_translate("home", "调入/出"))
        self.lots_pushButton.setText(_translate("home", "批量调入/出"))
        self.lots_new_material_pushButton.setText(_translate("home", "批量新增"))
        self.groupBox_2.setTitle(_translate("home", "信息统计"))
        self.material_info_btn.setText(_translate("home", "装备信息"))
        self.in_info_btn.setText(_translate("home", "调入信息"))
        self.out_info_btn.setText(_translate("home", "调出信息"))
        self.groupBox_3.setTitle(_translate("home", "数据删除"))
        self.clear_material_btn.setText(_translate("home", "清空装备数据"))
        self.clear_in_info_btn.setText(_translate("home", "清空调入数据"))
        self.clear_out_info_btn.setText(_translate("home", "清空调出数据"))
        self.groupBox_4.setTitle(_translate("home", "数据导入"))
        self.import_material_btn.setText(_translate("home", "导入装备数据"))
        self.import_in_info_btn.setText(_translate("home", "导入调入数据"))
        self.import_out_info_btn.setText(_translate("home", "导入调出数据"))
