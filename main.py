...
class homeWindow(QMainWindow, Ui_home):
    ...
    def __init__(self):
        ...
        if not flag:
            ...
            cur.execute(
                "create table material(material_id varchar(256) primary key,material_name varchar(256),spec varchar(256),unit varchar(256), per_price varchar(256), pos varchar(256), ori_num float,now_num float)")

            cur.execute(
                "create table in_log(date_time int,material_id varchar(256),material_name varchar(256),spec varchar(256),in_num float, per_price varchar(256), pos varchar(256), total_price varchar(256),user_man varchar(256),agree_man varchar(256), in_log_id INTEGER PRIMARY KEY AUTOINCREMENT)")

            cur.execute(
                "create table out_log(date_time int,material_id varchar(256),material_name varchar(256),spec varchar(256),out_num float,per_price varchar(256), pos varchar(256), total_price varchar(256),user_man varchar(256),agree_man varchar(256), out_log_id INTEGER PRIMARY KEY AUTOINCREMENT)")
...
QResource.registerResource("resource_rc.qrc")
window = homeWindow()
window.show()
os._exit(app.exec_())
