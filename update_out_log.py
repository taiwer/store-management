...
class Ui_update_out_log(object):
    ...
    def retranslateUi(self, update_out_log):
        ...
        update_out_log.setWindowTitle(_translate("update_out_log", "确认修改调出记录"))
        self.label_6.setText(_translate("update_out_log", "调出日期："))
        self.label_2.setText(_translate("update_out_log", "装备编码："))
        self.label_3.setText(_translate("update_out_log", "装备名称："))
        self.label.setText(_translate("update_out_log", "规格型号："))
        self.label_9.setText(_translate("update_out_log", "配发单位："))
        self.label_10.setText(_translate("update_out_log", "部署位置："))
        self.label_4.setText(_translate("update_out_log", "操作类型："))
        self.comboBox.setItemText(0, _translate("update_out_log", "调入"))
        self.comboBox.setItemText(1, _translate("update_out_log", "调出"))
        self.label_5.setText(_translate("update_out_log", "操作数量："))
        self.label_7.setText(_translate("update_out_log", "责任人："))
        self.label_8.setText(_translate("update_out_log", "责任单位："))
        self.cancel_pushButton.setText(_translate("update_out_log", "取消"))
        self.both_btn.setText(_translate("update_out_log", "修改调出记录和结存数量"))
